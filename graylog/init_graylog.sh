...
sed -i "s#rest_listen_uri = http://127.0.0.1:12900/#rest_listen_uri = http://0.0.0.0:12900/#" /opt/graylog/graylog.conf.example
sed -i "s+#web_listen_uri = http://127.0.0.1:9000/+web_listen_uri = http://0.0.0.0:9000/+" /opt/graylog/graylog.conf.example
